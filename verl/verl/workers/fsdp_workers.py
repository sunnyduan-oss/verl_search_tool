...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        print("actor module: ", actor_module)
        get_fsdp_wrap_policy = lambda module, config=None, is_lora=False: None
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        print("rollout name: ", rollout_config.name, ", rollout mode: ", rollout_config.mode)
